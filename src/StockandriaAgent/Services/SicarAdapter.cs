...
public class SicarAdapter : ISicarAdapter
{
    ...
    public async Task<object> SyncSalesAsync(JsonElement payload, CancellationToken ct)
    {
        ...
        //
        // OJO: no mandar `art_id`. Es un autoincrement LOCAL de cada base SICAR,
        // asi que el mismo producto tiene uno distinto en cada sucursal, y el
        // back guarda un solo sicar_code global. Cruzar por art_id le asigno a
        // cada producto el historial de otro (84% mal en una base real). La
        // clave es lo unico consistente entre sucursales.
        const string sql = @"
